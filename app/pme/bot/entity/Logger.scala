...
sealed trait LogLevel {
  ...
  protected val logger = PlayLogger(getClass)
...
object LogLevel {
  ...
  case object DEBUG extends LogLevel {
    ...
    override def checkEnabled(): Boolean = logger.isDebugEnabled
  }
  ...
  case object INFO extends LogLevel {
    ...
    override def checkEnabled(): Boolean = logger.isInfoEnabled
  }
  ...
  case object WARN extends LogLevel {
    ...
    override def checkEnabled(): Boolean = logger.isWarnEnabled
  }
  ...
  case object ERROR extends LogLevel {
    ...
    override def checkEnabled(): Boolean = logger.isErrorEnabled
  }
